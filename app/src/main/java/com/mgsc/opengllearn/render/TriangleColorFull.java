...
public class TriangleColorFull extends Shape {
    ...
    //顶点之间的便宜量
    private final int vertexStrid = COORDS_PER_VERTEX * 4;//每个顶点四个字节
    ...
    public void onDrawFrame(GL10 gl) {
        ...
        //准备三角形坐标数据
        GLES20.glVertexAttribPointer(mPositionHandle,COORDS_PER_VERTEX, GLES20.GL_FLOAT,false,vertexStrid,vertexBuffer);
        //获取片元着色器的vColor成员句柄
